  ...
  <body class="text-center">
	...
	<main class="form-getLetter">
	  <form action="" method="POST">
		...
		<a href="<?php print $script_url;?>/index.php?setlocal=yes&setDate=yes" class="btn btn-sm btn-warning mt-1">Letter with Custom Date & Location</a>
	  </form>
	  
	  <hr class="my-4">

    <p class="text-center mt-3 d-flex">
        <a href="https://events.dclm.org/personalizedflyer/" class="btn btn-primary btn-sm mr-auto">Global Crusade DP
      ...
      <a href="https://events.dclm.org/personalizedflyer/impact2022.php" class="btn btn-success btn-sm mr-auto">
          Impact Academy DP
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path fill="#FFFFFF" d="M13 18v-4h-7v-4h7v-4l6 6-6 6zm-1-16c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12z"/></svg></a>                
    </p> 
