<?php
	...
	{	
        ...
        //$message .= '<p style="color:#3e3f3e;font-size:16px;"> Kindly create your personalized banner here and share with your networks on social media. <a href="/"><strong> Create DP</strong></a></p>';
        // $message .= '<p style="color:#3e3f3e;font-size:16px;"> Download the YPF Leadership summit Agenda here. <a href="/"><strong> Get Event Agenda</strong></a></p>';
		...
		if ($con->query($str) === TRUE) {
			...
			header('location: confirm.html?utm_source=impact2022&utm_medium=confirmed-Registration&utm_term=&utm_content=&utm_campaign=');
		}
		else {
			echo "Error: " . $str . "<br>" . $con->error;
			header('location: confirm.html?utm_source=impact2022');
		}
    }
